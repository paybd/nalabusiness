...
export default function Faq() {
  return (
    <Accordion
      items={[
        { id: "q1", question: "What is Remitly?", answer: "An international money transfer app that lets you send from the UK, US and EU (and the Middle East) to many countries worldwide." },
        ...
        { id: "b1", question: "How does Remitly Business work?", answer: "We expand via local resellers and offer competitive exchange rates for bulk settlements." },
        ...
        { id: "b3", question: "How do I get business rates?", answer: (
          <span>
            Talk to our team on <a className="underline" href="https://wa.me/?text=I want to learn about Remitly Business rates" target="_blank" rel="noopener noreferrer">WhatsApp</a>.
          </span>
        ) },
      ]}
      defaultOpenId="q1"
